...
void handleRoot() {
  ...
  if (redirectURL.length() > 0) {
    // Create HTML with redirect functionality
    String htmlWithRedirect = "<!DOCTYPE HTML>"
                             ...
                             ".button { display: block; margin: 10px auto; padding: 15px 30px; font-size: 16px; width: 32ch; background-color: #f39c12; color: white; border: none; border-radius: 5px; cursor: pointer; box-sizing: border-box; text-align: left; overflow: hidden; white-space: nowrap; text-overflow: ellipsis;}"
                             ".active { background-color: #2ecc71; }"
                             "#countdown { color: #fff; font-size: 1.5em; margin: 15px 0; font-weight: bold; background: rgba(0,0,0,0.3); padding: 10px; border-radius: 8px; }"
                             ".cancel-btn { background: #e74c3c; color: white; border: none; padding: 10px 20px; border-radius: 5px; margin: 10px; cursor: pointer; font-size: 14px; }"
                             "</style>"
                             "<script>"
                             ...
                             "  document.getElementById('countdown').innerHTML = '🔄 Redirecting in: <strong>' + display + '</strong>';"
                             "}"
                             ""
                             ...
                             "    document.getElementById('countdown').style.background = 'rgba(231, 76, 60, 0.3)';"
                             "  }"
                             "}"
                             ""
                             "setInterval(updateRelayStates, 1000);"
